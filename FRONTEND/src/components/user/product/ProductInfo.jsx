...
{/* <div className="mb-6 p-4 border rounded-lg bg-white shadow-sm space-y-4">
      {bestSeller && (
        <div className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-full inline-block mb-2">
          BEST SELLER
        </div>
      )}
      <h1 className="text-3xl font-bold mb-2">{name}</h1>
      <div className="flex items-center mb-4 space-x-2">
        ...
        <span className={totalStock !== 0 ? "text-green-500" : "text-red-600"}>
      ...
      <p className="text-black text-sm">(MRP Inclusive of Taxes)</p>
