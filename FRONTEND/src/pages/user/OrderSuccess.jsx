...
export default function OrderSuccess() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
        <Navbar/>
      {data && <div className="container mx-auto px-4 py-6 max-w-4xl">
        {/* Breadcrumb */}
          ...
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-sm-bold">₹{data.totalAmount}</span>
              </div>
             {data.transactionId && ( <div className="flex justify-between text-sm">
            ...
            <div className="rounded-lg bg-primary/5 p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Arriving By {expectedDeliveryDate}</span>
                </div>
